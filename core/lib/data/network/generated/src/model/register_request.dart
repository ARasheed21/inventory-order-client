...
/// Payload for POST /auth/register. Creates an account with ROLE_CUSTOMER.
///
/// Properties:
/// * [username] - Unique username; becomes the order customerId for this user
/// * [email] - Unique email address
/// * [password] - Password: minimum 8 characters, must contain at least one letter and one digit
@BuiltValue()
abstract class RegisterRequest
    implements Built<RegisterRequest, RegisterRequestBuilder> {
  /// Unique username; becomes the order customerId for this user
