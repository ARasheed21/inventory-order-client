...
class AuthenticationApi {
  ...
  /// Returns JWT access + refresh tokens. Rate limited per username: after security.login.max-attempts failures within the window, requests return 429 until it expires.
  ///
  /// Parameters:
  /// * [loginRequest]
  ...
  /// Resolves the authenticated principal and returns id, username, email, and ROLE_-prefixed roles.
  ///
  /// Parameters:
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject?>>> me({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Validates the refresh JWT and issues a new access/refresh token pair for its subject.
  ///
  /// Parameters:
  /// * [refreshRequest]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  ...
  /// Creates an account with ROLE_CUSTOMER and returns tokens immediately. Passwords must be at least 8 characters and contain a letter and a digit.
  ///
  /// Parameters:
  /// * [registerRequest]
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
